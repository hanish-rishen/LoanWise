...
var _a, _b;
_b = entityKind, _a = Symbol.toStringTag;
var QueryPromise = class {
  constructor() {
    __publicField(this, _a, "QueryPromise");
  }
  catch(onRejected) {
...
__publicField(ForeignKeyBuilder, _a4, "PgForeignKeyBuilder");
var _a5;
_a5 = entityKind;
...
__publicField(ForeignKey, _a5, "PgForeignKey");
...
__publicField(UniqueConstraintBuilder, _a6, "PgUniqueConstraintBuilder");
var _a7;
_a7 = entityKind;
...
__publicField(UniqueOnConstraintBuilder, _a7, "PgUniqueOnConstraintBuilder");
var _a8;
_a8 = entityKind;
...
__publicField(UniqueConstraint, _a8, "PgUniqueConstraint");
...
var _a9, _b2;
var PgColumnBuilder = class extends (_b2 = ColumnBuilder, _a9 = entityKind, _b2) {
  constructor() {
    super(...arguments);
...
__publicField(PgColumnBuilder, _a9, "PgColumnBuilder");
var _a10, _b3;
var PgColumn = class extends (_b3 = Column, _a10 = entityKind, _b3) {
  constructor(table, config) {
...
__publicField(PgColumn, _a10, "PgColumn");
var _a11, _b4;
var ExtraConfigColumn = class extends (_b4 = PgColumn, _a11 = entityKind, _b4) {
  constructor() {
    super(...arguments);
...
__publicField(ExtraConfigColumn, _a11, "ExtraConfigColumn");
var _a12;
_a12 = entityKind;
...
__publicField(IndexedColumn, _a12, "IndexedColumn");
var _a13, _b5;
var PgArrayBuilder = class extends (_b5 = PgColumnBuilder, _a13 = entityKind, _b5) {
...
__publicField(PgArrayBuilder, _a13, "PgArrayBuilder");
var _a14, _b6;
var _PgArray = class _PgArray extends (_b6 = PgColumn, _a14 = entityKind, _b6) {
...
__publicField(_PgArray, _a14, "PgArray");
var PgArray = _PgArray;

// node_modules/drizzle-orm/pg-core/columns/enum.js
var _a15, _b7;
var PgEnumObjectColumnBuilder = class extends (_b7 = PgColumnBuilder, _a15 = entityKind, _b7) {
...
__publicField(PgEnumObjectColumnBuilder, _a15, "PgEnumObjectColumnBuilder");
var _a16, _b8;
var PgEnumObjectColumn = class extends (_b8 = PgColumn, _a16 = entityKind, _b8) {
  constructor(table, config) {
    super(table, config);
...
__publicField(PgEnumObjectColumn, _a16, "PgEnumObjectColumn");
var isPgEnumSym = Symbol.for("drizzle:isPgEnum");
function isPgEnum(obj) {
  return !!obj && typeof obj === "function" && isPgEnumSym in obj && obj[isPgEnumSym] === true;
}
var _a17, _b9;
var PgEnumColumnBuilder = class extends (_b9 = PgColumnBuilder, _a17 = entityKind, _b9) {
  constructor(name2, enumInstance) {
...
var _a18, _b10;
var PgEnumColumn = class extends (_b10 = PgColumn, _a18 = entityKind, _b10) {
  constructor(table, config) {
    super(table, config);
...
var _a20, _b11;
var WithSubquery = class extends (_b11 = Subquery, _a20 = entityKind, _b11) {
};
...
var _a21, _b12, _c, _d, _e, _f, _g, _h, _i, _j;
_j = entityKind, _i = TableName, _h = OriginalName, _g = Schema, _f = Columns, _e = ExtraConfigColumns, _d = BaseName, _c = IsAlias, _b12 = IsDrizzleTable, _a21 = ExtraConfigBuilder;
var Table = class {
...
var _a28, _b13, _c2;
_c2 = entityKind, _b13 = ViewBaseConfig, _a28 = IsDrizzleView;
var View = class {
  constructor({ name: name2, schema, selectedFields, query }) {
    /** @internal */
    __publicField(this, _b13);
    /** @internal */
    __publicField(this, _a28, true);
    this[ViewBaseConfig] = {
      name: name2,
      originalName: name2,
      schema,
...
__publicField(ColumnAliasProxyHandler, _a29, "ColumnAliasProxyHandler");
var _a30;
_a30 = entityKind;
...
__publicField(TableAliasProxyHandler, _a30, "TableAliasProxyHandler");
var _a31;
_a31 = entityKind;
...
__publicField(RelationTableAliasProxyHandler, _a31, "RelationTableAliasProxyHandler");
...
var _a76, _b58;
var PgNumericNumberBuilder = class extends (_b58 = PgColumnBuilder, _a76 = entityKind, _b58) {
  constructor(name2, precision, scale) {
...
__publicField(PgNumericNumberBuilder, _a76, "PgNumericNumberBuilder");
var _a77, _b59;
var PgNumericNumber = class extends (_b59 = PgColumn, _a77 = entityKind, _b59) {
  constructor(table, config) {
    super(table, config);
    __publicField(this, "precision");
    __publicField(this, "scale");
...
__publicField(PgNumericNumber, _a77, "PgNumericNumber");
var _a78, _b60;
var PgNumericBigIntBuilder = class extends (_b60 = PgColumnBuilder, _a78 = entityKind, _b60) {
  constructor(name2, precision, scale) {
...
__publicField(PgNumericBigIntBuilder, _a78, "PgNumericBigIntBuilder");
var _a79, _b61;
var PgNumericBigInt = class extends (_b61 = PgColumn, _a79 = entityKind, _b61) {
  constructor(table, config) {
    super(table, config);
    __publicField(this, "precision");
    __publicField(this, "scale");
...
__publicField(PgNumericBigInt, _a79, "PgNumericBigInt");
...
var _a80, _b62;
var PgPointTupleBuilder = class extends (_b62 = PgColumnBuilder, _a80 = entityKind, _b62) {
  constructor(name2) {
...
var _a81, _b63;
var PgPointTuple = class extends (_b63 = PgColumn, _a81 = entityKind, _b63) {
  getSQLType() {
    return "point";
  }
  mapFromDriverValue(value) {
...
var _a82, _b64;
var PgPointObjectBuilder = class extends (_b64 = PgColumnBuilder, _a82 = entityKind, _b64) {
  constructor(name2) {
...
var _a83, _b65;
var PgPointObject = class extends (_b65 = PgColumn, _a83 = entityKind, _b65) {
  getSQLType() {
    return "point";
  }
  mapFromDriverValue(value) {
...
var _a84, _b66;
var PgGeometryBuilder = class extends (_b66 = PgColumnBuilder, _a84 = entityKind, _b66) {
  constructor(name2) {
...
var _a85, _b67;
var PgGeometry = class extends (_b67 = PgColumn, _a85 = entityKind, _b67) {
  getSQLType() {
...
var _a86, _b68;
var PgGeometryObjectBuilder = class extends (_b68 = PgColumnBuilder, _a86 = entityKind, _b68) {
  constructor(name2) {
...
var _a87, _b69;
var PgGeometryObject = class extends (_b69 = PgColumn, _a87 = entityKind, _b69) {
  getSQLType() {
    return "geometry(point)";
  }
  mapFromDriverValue(value) {
...
var _a88, _b70;
var PgRealBuilder = class extends (_b70 = PgColumnBuilder, _a88 = entityKind, _b70) {
...
var _a89, _b71;
var PgReal = class extends (_b71 = PgColumn, _a89 = entityKind, _b71) {
  constructor(table, config) {
    super(table, config);
...
var _a90, _b72;
var PgSerialBuilder = class extends (_b72 = PgColumnBuilder, _a90 = entityKind, _b72) {
  constructor(name2) {
...
var _a91, _b73;
var PgSerial = class extends (_b73 = PgColumn, _a91 = entityKind, _b73) {
  getSQLType() {
    return "serial";
  }
};
...
var _a92, _b74;
var PgSmallIntBuilder = class extends (_b74 = PgIntColumnBaseBuilder, _a92 = entityKind, _b74) {
  constructor(name2) {
...
var _a93, _b75;
var PgSmallInt = class extends (_b75 = PgColumn, _a93 = entityKind, _b75) {
  constructor() {
    super(...arguments);
    __publicField(this, "mapFromDriverValue", (value) => {
      if (typeof value === "string") {
...
var _a94, _b76;
var PgSmallSerialBuilder = class extends (_b76 = PgColumnBuilder, _a94 = entityKind, _b76) {
  constructor(name2) {
...
var _a95, _b77;
var PgSmallSerial = class extends (_b77 = PgColumn, _a95 = entityKind, _b77) {
  getSQLType() {
    return "smallserial";
  }
};
...
var _a96, _b78;
var PgTextBuilder = class extends (_b78 = PgColumnBuilder, _a96 = entityKind, _b78) {
  constructor(name2, config) {
...
var _a97, _b79;
var PgText = class extends (_b79 = PgColumn, _a97 = entityKind, _b79) {
  constructor() {
    super(...arguments);
    __publicField(this, "enumValues", this.config.enumValues);
  }
...
var _a98, _b80;
var PgTimeBuilder = class extends (_b80 = PgDateColumnBaseBuilder, _a98 = entityKind, _b80) {
...
var _a99, _b81;
var PgTime = class extends (_b81 = PgColumn, _a99 = entityKind, _b81) {
  constructor(table, config) {
    super(table, config);
...
var _a100, _b82;
var PgTimestampBuilder = class extends (_b82 = PgDateColumnBaseBuilder, _a100 = entityKind, _b82) {
  constructor(name2, withTimezone, precision) {
...
var _a101, _b83;
var PgTimestamp = class extends (_b83 = PgColumn, _a101 = entityKind, _b83) {
  constructor(table, config) {
    super(table, config);
    __publicField(this, "withTimezone");
    __publicField(this, "precision");
...
var _a102, _b84;
var PgTimestampStringBuilder = class extends (_b84 = PgDateColumnBaseBuilder, _a102 = entityKind, _b84) {
  constructor(name2, withTimezone, precision) {
...
var _a103, _b85;
var PgTimestampString = class extends (_b85 = PgColumn, _a103 = entityKind, _b85) {
  constructor(table, config) {
    super(table, config);
    __publicField(this, "withTimezone");
    __publicField(this, "precision");
...
var _a104, _b86;
var PgUUIDBuilder = class extends (_b86 = PgColumnBuilder, _a104 = entityKind, _b86) {
  constructor(name2) {
...
var _a105, _b87;
var PgUUID = class extends (_b87 = PgColumn, _a105 = entityKind, _b87) {
  getSQLType() {
    return "uuid";
  }
};
...
var _a106, _b88;
var PgVarcharBuilder = class extends (_b88 = PgColumnBuilder, _a106 = entityKind, _b88) {
  constructor(name2, config) {
...
var _a107, _b89;
var PgVarchar = class extends (_b89 = PgColumn, _a107 = entityKind, _b89) {
  constructor() {
    super(...arguments);
    __publicField(this, "length", this.config.length);
    __publicField(this, "enumValues", this.config.enumValues);
...
var _a108, _b90;
var PgBinaryVectorBuilder = class extends (_b90 = PgColumnBuilder, _a108 = entityKind, _b90) {
  constructor(name2, config) {
...
var _a109, _b91;
var PgBinaryVector = class extends (_b91 = PgColumn, _a109 = entityKind, _b91) {
  constructor() {
    super(...arguments);
...
var _a110, _b92;
var PgHalfVectorBuilder = class extends (_b92 = PgColumnBuilder, _a110 = entityKind, _b92) {
  constructor(name2, config) {
...
var _a111, _b93;
var PgHalfVector = class extends (_b93 = PgColumn, _a111 = entityKind, _b93) {
  constructor() {
    super(...arguments);
    __publicField(this, "dimensions", this.config.dimensions);
  }
...
var _a112, _b94;
var PgSparseVectorBuilder = class extends (_b94 = PgColumnBuilder, _a112 = entityKind, _b94) {
  constructor(name2, config) {
...
var _a113, _b95;
var PgSparseVector = class extends (_b95 = PgColumn, _a113 = entityKind, _b95) {
  constructor() {
    super(...arguments);
    __publicField(this, "dimensions", this.config.dimensions);
  }
...
var _a114, _b96;
var PgVectorBuilder = class extends (_b96 = PgColumnBuilder, _a114 = entityKind, _b96) {
  constructor(name2, config) {
...
var _a115, _b97;
var PgVector = class extends (_b97 = PgColumn, _a115 = entityKind, _b97) {
  constructor() {
    super(...arguments);
    __publicField(this, "dimensions", this.config.dimensions);
  }
...
var _a116, _b98, _c3, _d2, _e2, _f2;
var PgTable = class extends (_f2 = Table, _e2 = entityKind, _d2 = InlineForeignKeys, _c3 = EnableRLS, _b98 = Table.Symbol.ExtraConfigBuilder, _a116 = Table.Symbol.ExtraConfigColumns, _f2) {
  constructor() {
    super(...arguments);
    /**@internal */
...
var _a119, _b99;
var DrizzleError = class extends (_b99 = Error, _a119 = entityKind, _b99) {
...
var _a120, _b100;
var TransactionRollbackError = class extends (_b100 = DrizzleError, _a120 = entityKind, _b100) {
  constructor() {
...
//# sourceMappingURL=chunk-ZOHBQ7D6.js.map
