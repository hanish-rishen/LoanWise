...
var Gs = T((Mt) => {
  ...
  var k = ln(), qc = js(), wn = 1, Qc = 4, Hs = wn + Qc, $s = d.allocUnsafe(0), bn = class bn {
    constructor(e) {
      if (this.buffer = $s, this.bufferLength = 0, this.bufferOffset = 0, this.reader = new qc.BufferReader(), (e == null ? void 0 : e.mode) === "binary") throw new Error("Binary mode not supported yet");
  ...
  toParameterizedQuery(e = { query: "", params: [] }) {
    ...
    for (let i = 0, s = t.length; i < s; i++) if (e.query += t[i], i < n.length) {
      ...
      if (o instanceof Ge) e.query += o.sql;
        ...
        if ((_a = o.queryData.params) == null ? void 0 : _a.length) throw new Error("This query is not composable");
...
@neondatabase/serverless/index.mjs:
  ...
  *)
*/
//# sourceMappingURL=chunk-AGS36L67.js.map
