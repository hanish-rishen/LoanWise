          ...
          <div className="flex-shrink-0">
            ...
            <div className="p-4 border-b border-gray-700/30">
              <div className="flex items-center justify-between">
                ...
                `}>
                  {/* Minimal Logo with dot - Inspired by reference */}
                  <div className="relative">
                    <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center shadow-sm">
                      {/* Simple "L" shape design with dot */}
            ...
            <nav className="p-4 flex-1 overflow-hidden flex flex-col">
              ...
              `}>
                ...
                {/* Chat List with proper height management */}
                <div className="overflow-y-auto flex-1 space-y-1 custom-scrollbar-thin" style={{ maxHeight: 'calc(100vh - 280px)' }}>
                  {recentChats.map((chat) => (
                    <div key={chat.id} className="group relative">
                      <button
                        onClick={() => handleConversationClick(chat.id)}
                        className="w-full p-3 rounded-lg bg-gray-800/50 hover:bg-gray-700/60
