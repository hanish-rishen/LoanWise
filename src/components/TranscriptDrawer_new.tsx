...
const TranscriptDrawer: React.FC<TranscriptDrawerProps> = ({ isOpen, onClose, messages = [] }) => {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div className="fixed right-0 top-0 h-full w-96 bg-gradient-to-br from-gray-900/95 via-gray-800/95 to-gray-900/95 backdrop-blur-2xl border-l border-white/20 z-50 transform transition-transform duration-300 ease-out shadow-2xl">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          {messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-64 text-center">
              ...
              <h3 className="text-white/80 font-medium mb-2">No Conversations Yet</h3>
              <p className="text-white/50 text-sm leading-relaxed">
                Start a voice conversation to see your transcript here
              </p>
            </div>
          ) : (
